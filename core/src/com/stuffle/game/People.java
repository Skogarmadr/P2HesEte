...
public abstract class People
{
    ...
    protected AutoAttaque autoAttaque;
    ...
    private Vector2 nbTexture = Vector2.Zero;
            ...
            int _initPosY, World _world)
    {
        ...
        // le point de coordoné 0 est au centre de l'objet
        // tout est divisé par 100 car on fait un zoom
        // bodyDef.position.set(0.5f, 500/PPM);
        ...
        fixtureDef.density = 50 / (9.79f * 9.79f);
